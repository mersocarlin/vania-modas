 ...
 */
public class CadastroProdutoGer extends javax.swing.JFrame {
    ...
    public CadastroProdutoGer(Sessao sessao) {
        initComponents();
    ...
    public CadastroProdutoGer(HashMap<String, Object> c, Sessao sessao) {
        initComponents();
        controlador = new Controlador();
        this.construtor(sessao);
        this.mostraDados(c);
    ...
    private HashMap<String, Object> pegaDados() {
        ...
        h = this.trataPreco(jTextFieldValorCompra.getText());
        if (!h.equals("erro")) {
            retorno.put("valorCompra", h);
        } else {
            return null;
        }
    ...
    public void mostraDados(HashMap<String, Object> produto) {
        ...
        if (produto != null) {
            ...
            jTextFieldValorCompra.setText((String) produto.get("valorCompra"));
...
private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
    if (evt.getClickCount() == 2) {
        if (jTable1.getSelectedRow() >= 0) {
            RecebimentoGer recebimento = new RecebimentoGer("produto#"+jTextFieldCod.getText(), (DefaultTableModel) jTable1.getModel(), jTable1.getSelectedRow(), sessao);
            recebimento.show();
            this.dispose();
        }
    }
...
//        ((CodigoBarra) jPanelCodigo).setBarCode2D(barCode);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new CadastroProdutoGer().setVisible(true);
            }
        });
    }
