 ...
 */
public class RecebimentoGer extends javax.swing.JFrame {
    ...
    public RecebimentoGer(String visao, DefaultTableModel model, int linhaSelecionada, Sessao sessao) {
        initComponents();
        this.visao = visao;
    ...
    private void initComponents() {
        ...
        jButtonSair.setToolTipText("Volta para a tela principal");
    ...
    private void jButtonVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVoltarActionPerformed
        ...
        if (this.visao.equals("cliente")) {
            ...
            new CadastroClienteGer(caixa, sessao).show();
            this.dispose();
        } else {
            if (this.visao.equals("funcionario")) {
                caixa.put("cod", jTextFieldCodigoFuncionario.getText());
                caixa = controlador.recebeOperacao(caixa);
                new CadastroFuncionarioGer(caixa, sessao).show();
                this.dispose();
            } else {
                if (this.visao.split("#")[0].equals("produto")) {
                    caixa.put("cod", this.visao.split("#")[1]);
                    caixa = controlador.recebeOperacao(caixa);
                    new CadastroProdutoGer(caixa, sessao).show();
                    this.dispose();
                }
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new RecebimentoGer().setVisible(true);
            }
        });
    }
    ...
    private void construtor(Sessao sessao) {
        ...
        if (!visao.equals("cliente")) {
            ...
            if (visao.equals("funcionario")) {
                ...
                jButtonSair.setToolTipText("Volta para a tela principal");
                jButtonVoltar.setToolTipText("Volta para o cadastro do funcionario");
                jButtonPrimeiraVenda.setToolTipText("Primeira venda do funcionario");
                jButtonProximaVenda.setToolTipText("Proxima venda do funcionario");
                jButtonVendaAnterior.setToolTipText("Venda anterior do funcionario");
                jButtonUltimaVenda.setToolTipText("Ultima venda do funcionario");
            } else {
                if (visao.split("#")[0].equals("produto")) {
                    this.setTitle("Historico de saida de produto");
                    jButtonSair.setToolTipText("Volta para a tela principal");
                    jButtonVoltar.setToolTipText("Volta para o cadastro do produto");
                    jButtonPrimeiraVenda.setToolTipText("Primeira venda com este produto");
                    jButtonProximaVenda.setToolTipText("Proxima venda com este produto");
                    jButtonVendaAnterior.setToolTipText("Venda anterior com este produto");
                    jButtonUltimaVenda.setToolTipText("Ultima venda com este produto");
