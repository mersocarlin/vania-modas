 ...
 */
public class TelaVendaFun extends javax.swing.JFrame {
    ...
    public TelaVendaFun(Sessao sessao, String tipo) {
        initComponents();
        tipoVenda = tipo;
    ...
    private void initComponents() {
        ...
        jTextFieldCodigoCliente.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        jComboBoxFuncionario.setFocusable(false);
        ...
        jButtonConsultaFuncionario.setFocusable(false);
        ...
        jTextFieldValorEntrada.setFont(new java.awt.Font("Arial", 1, 18));
...
private void jComboBoxVezesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jComboBoxVezesMouseReleased
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new TelaVendaFun().setVisible(true);
            }
        });
    }
