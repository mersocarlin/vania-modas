 ...
 *
 * Created on 02/06/2009, 14:40:32
 */
...
public class CadastroClienteFun extends javax.swing.JFrame {
    ...
    public CadastroClienteFun(Sessao sessao) {
        initComponents();
    ...
    public CadastroClienteFun(HashMap<String, Object> c, Sessao sessao) {
        initComponents();
        this.construtor(sessao);
        this.mostraDados(c);
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jFormattedTextFieldFoneRefCom1, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jFormattedTextFieldFoneRefCom2, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTableComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableComprasMouseClicked
        if (evt.getClickCount() == 2) {
            if (jTableCompras.getSelectedRow() >= 0) {
                RecebimentoFun recebimento = new RecebimentoFun("cliente", (DefaultTableModel) jTableCompras.getModel(), jTableCompras.getSelectedRow(), sessao);
                recebimento.show();
                this.dispose();
            }
        }
